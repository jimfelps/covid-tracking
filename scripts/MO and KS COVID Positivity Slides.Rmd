...
metro_kc_grouped %>% 
  ...
  labs(
    ...
    subtitle = 'Based on <b style="color:#d61616">Confirmed Positives</b> and <b style="color:#d616b9">Projected Positives</b>. Projected positives based on WaPost quote indicating that the true number of cases is likely ten times what we\'ve confirmed.',
    caption = "Data from NYT Covid repository \nhttps://github.com/nytimes/covid-19-data\nVisual: Jim Felps"
  ) +
  guides(color = FALSE) +
  scale_x_date(expand = c(0,15)) +
...
state_data %>%
  ...
  ggplot() +
    ...
    labs(
      x = "",
      y = "",
      title = 'Patients in Arizona Currently <b style="color:#1b61da">Hospitalized</b> for COVID (TX doesn\'t report vent usage)',
      subtitle = '<b style="color:#0c7650">Daily New Positive Cases</b>',
      caption = "Data from COVID Tracking project\nhttps://covidtracking.com/\nVisual: Jim Felps"
        )   +
  theme_minimal() +
